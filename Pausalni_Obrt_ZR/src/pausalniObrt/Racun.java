...
public class Racun {
	...
	public Racun(int sifra, String broj_racuna, int klijent_kupac_id, Date datum_izdavanja, Date datum_dospijeca,
			Date datum_isporuke, int izdao_user_id, String napomena, String nacin_placanja, Double iznos_racuna) {
		this.sifra = sifra;
